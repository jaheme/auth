...
Ext.ux.ThemeChange = Ext.extend(Ext.form.ComboBox, {
	...
	initEvents : function() {
		this.on('collapse', function() {
			Ext.util.CSS.swapStyleSheet('theme', '/ProductManager/ext/resources/css/'+ this.getValue());
		});
	}
});
//把定义好的Ext.ux.ThemeChange注册给名称为themeChange的变量
